...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_dim5 = QtWidgets.QLabel(self.splitter_actions)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_dim5.sizePolicy().hasHeightForWidth())
        self.label_dim5.setSizePolicy(sizePolicy)
        self.label_dim5.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_dim5.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_dim5.setObjectName("label_dim5")
        self.spinBox_dim5 = QtWidgets.QSpinBox(self.splitter_actions)
        self.spinBox_dim5.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinBox_dim5.sizePolicy().hasHeightForWidth())
        self.spinBox_dim5.setSizePolicy(sizePolicy)
        self.spinBox_dim5.setMaximumSize(QtCore.QSize(50, 16777215))
        self.spinBox_dim5.setObjectName("spinBox_dim5")
        self.label_dim5_max = QtWidgets.QLabel(self.splitter_actions)
        self.label_dim5_max.setMinimumSize(QtCore.QSize(55, 0))
        self.label_dim5_max.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_dim5_max.setObjectName("label_dim5_max")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_dim5.setText(_translate("MainWindow", "Dim 5:"))
        self.label_dim5_max.setText(_translate("MainWindow", "/0"))
